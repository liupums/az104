...
namespace daemon_console
{
    ...
    class Program
    {
        ...
        private static X509Certificate2 ReadCertificateByThumbprint(string thumbprint)
        {
            if (string.IsNullOrWhiteSpace(thumbprint))
            {
                throw new ArgumentException("thumbprint should not be empty. Please set the CertificateThumbprint setting in the appsettings.json", "thumbprint");
            }
    
            CertificateDescription certificateDescription = CertificateDescription.FromStoreWithThumbprint(thumbprint);
            DefaultCertificateLoader defaultCertificateLoader = new DefaultCertificateLoader();
            defaultCertificateLoader.LoadIfNeeded(certificateDescription);
            return certificateDescription.Certificate;
        }
